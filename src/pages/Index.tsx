    ...
    <div className="min-h-screen" style={{ backgroundColor: "var(--dark-bg)", color: "var(--cream)" }}>
      ...
      {activeSection === "home" && (
        <section className="relative min-h-screen flex items-center overflow-hidden">
          ...
          {/* Free reading banner — bottom right */}
          <div
            className="absolute bottom-10 right-6 md:right-12 z-10 animate-fade-up"
            style={{ opacity: 0, animationDelay: "0.9s", maxWidth: "320px" }}
          >
            <div
            ...
            >
              ...
              />
              {/* Corner accents */}
              <div className="absolute top-0 left-0 w-4 h-4" style={{ borderTop: "1px solid var(--gold)", borderLeft: "1px solid var(--gold)" }} />
              <div className="absolute bottom-0 right-0 w-4 h-4" style={{ borderBottom: "1px solid var(--gold)", borderRight: "1px solid var(--gold)" }} />
              ...
              <div className="relative">
                ...
                <h3 className="font-cormorant text-2xl font-light mb-2 leading-snug">
                  Расклад на прошлое
                </h3>
                <p className="font-montserrat text-xs mb-4" style={{ color: "var(--cream-dim)", fontWeight: 300, lineHeight: "1.6" }}>
                  Три карты Таро раскроют скрытые силы и уроки вашего прошлого
                </p>
                <div className="flex items-center gap-2" style={{ color: "var(--gold)" }}>
                  <span className="font-montserrat text-xs" style={{ letterSpacing: "0.12em" }}>ПОЛУЧИТЬ РАСКЛАД</span>
      ...
      {activeSection === "home" && (
        <section
          ...
          style={{ background: "linear-gradient(180deg, var(--dark-bg) 0%, #120f0a 50%, var(--dark-bg) 100%)" }}
        >
          <div className="container mx-auto max-w-5xl">
            <div
              className="relative overflow-hidden p-8 md:p-12 animate-fade-up"
            ...
            >
              ...
              {/* Corner decorations */}
              <div className="absolute top-0 left-0 w-8 h-8" style={{ borderTop: "1px solid var(--gold)", borderLeft: "1px solid var(--gold)" }} />
              <div className="absolute top-0 right-0 w-8 h-8" style={{ borderTop: "1px solid var(--gold)", borderRight: "1px solid var(--gold)" }} />
              <div className="absolute bottom-0 left-0 w-8 h-8" style={{ borderBottom: "1px solid var(--gold)", borderLeft: "1px solid var(--gold)" }} />
              <div className="absolute bottom-0 right-0 w-8 h-8" style={{ borderBottom: "1px solid var(--gold)", borderRight: "1px solid var(--gold)" }} />

              <div className="relative flex flex-col md:flex-row items-center gap-8 md:gap-12">

                {/* Cards visual */}
                <div className="flex-shrink-0 relative w-28 h-40 hidden md:block">
                  {[2, 1, 0].map((i) => (
                    <div
                      key={i}
                      ...
                      style={{
                        border: "1px solid var(--gold-dim)",
                        background: `linear-gradient(135deg, #1e1810 0%, #0e0b08 100%)`,
                ...
                <div className="flex-1 text-center md:text-left">
                  <div className="flex items-center justify-center md:justify-start gap-3 mb-3">
                    ...
                    <span className="font-montserrat text-xs" style={{ color: "var(--gold)", letterSpacing: "0.18em" }}>
                      БЕСПЛАТНО
                    </span>
                    <div style={{ height: "1px", width: "30px", background: "var(--gold)" }} />
                  </div>
                  <h2 className="font-cormorant text-4xl md:text-5xl font-light mb-3">
                    Персональный расклад<br />
                    <em style={{ color: "var(--gold)" }}>на ваше прошлое</em>
                  </h2>
                  <p className="font-montserrat text-sm mb-6 max-w-lg" style={{ color: "var(--cream-dim)", fontWeight: 300, lineHeight: "1.7" }}>
                    Три карты Таро, выбранные специально для вас, откроют скрытые силы, события и уроки прошлого — то, что сформировало вас сегодня.
                  </p>
                  <div className="flex flex-wrap gap-3 justify-center md:justify-start items-center">
                    ...
                    <span className="font-montserrat text-xs" style={{ color: "var(--cream-dim)" }}>
                      Займёт 2 минуты
                    </span>
                  </div>
                </div>
                ...
                {/* Stats */}
                <div
                  className="flex-shrink-0 flex flex-row md:flex-col gap-6 md:gap-8 md:pl-12"
                  style={{ borderLeft: "none" }}
                >
                  {[
                    { num: "3", label: "карты прошлого" },
                    { num: "0 ₽", label: "полностью бесплатно" },
                    { num: "2 мин", label: "время расклада" },
                  ].map((s) => (
                    <div key={s.label} className="text-center md:text-right">
                      <p className="font-cormorant text-2xl md:text-3xl" style={{ color: "var(--gold)" }}>{s.num}</p>
                      <p className="font-montserrat text-xs mt-1" style={{ color: "var(--cream-dim)", letterSpacing: "0.06em" }}>{s.label}</p>
                    </div>
                  ))}
                </div>
